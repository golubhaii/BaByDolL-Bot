...
# PyroClient Setup 
API_ID = int(environ['28430134'])
API_HASH = environ['c3cd07e1c60c6ab046ef34a8d5aa7514']
BOT_TOKEN = environ['6181732075:AAEdRy-OmccQPFFf8SfRNfStckH_GUqAFFw']
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001842498325').split()]
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://LilyAdams:LilyAdams@cluster02.wnrf1uc.mongodb.net/?retryWrites=true&w=majority")
...
# url shortner
SHORT_URL = environ.get("paisakamalo.in")
SHORT_API = environ.get("f3321e1d3c26139b3be7e759018d6e875dcba1b5")
